...
class LangTRans:
    ...
    def main_window(self):
        ...
        head_label=Label(self.window,bg=BG_COLOR,fg=TEXT_COLOR,text="Welcome to NIT NAGALAND",font=FONT_BOLD,pady=10)
    ...
    def on_enter(self,event):
        ...
        self.my_msg(msg,"Nagamese")
        self.deocded_output(msg,"English")
